...
## [0.1.2](https://github.com/caass/twice-cell/compare/v0.1.1...v0.1.2) - 2025-01-18

### Other

- Remove dropcheck marker
- Remove doc comment from zed settings ([#19](https://github.com/caass/twice-cell/pull/19))
- *(changelog)* add PR links to changes (#18)
